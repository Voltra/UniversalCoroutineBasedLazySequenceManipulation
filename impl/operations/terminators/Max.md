...
template <T>
@ExtensionMethod
Nullable<T> maxBy(Stream<T> this, Mapper<T, Number> keyFactory){
...
@ExtensionMethod
Nullable<Number> max(Stream<Number> this){
	return this.maxBy(x => x);
}

template <T>
@ExtensionMethod
Nullable<T> maxWith(Stream<T> this, Comparator<T> comparator){
